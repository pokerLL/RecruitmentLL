  ...
  <div style="width:50%;left: 20%;position: absolute;">
    <el-form :model="form" label-width="120px">
      ...
      <el-form-item label="个人照片">
        <el-upload ref="userPicture" action="http://127.0.0.1:3000/api/picture/"
                   :auto-upload="false" :on-success="uploadUserPictureSuccess">
          <template #trigger>
      ...
      <el-form-item label="简历附件">
        <el-upload ref="attachment" action="http://127.0.0.1:3000/api/attachment/"
                   :auto-upload="false" :on-success="uploadAttachmentSuccess">
          <template #trigger>
            <el-button type="primary">select file</el-button>
          </template>
