...
class Resume(models.Model):
    ...
    city = models.ForeignKey(City,null=True, on_delete=models.DO_NOTHING, verbose_name=_('城市'))
    ...
    # 学校与学历信息
    bachelor_school = models.CharField(max_length=135, blank=True,null=True, verbose_name=_('本科学校'))
    master_school = models.CharField(max_length=135, blank=True,null=True, verbose_name=_('研究生学校'))
    doctor_school = models.CharField(max_length=135, blank=True,null=True, verbose_name=u'博士生学校')
