...
SECRET_KEY = 'django-insecure-_5fxzn2ujsn^8l$)%9yl3typx6$_^r&2et#74ifjv-8#v!fwnj'
...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware', # 注意位置
...
# 自动展示model所有字段的app
SHOW_MODEL_LIST = ['jobs','interview']
